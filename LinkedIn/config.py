...
keywords = ["python", "programming", "software engineer", "backend", "software developer", "golang", "java", "c#", ".net", "sql", "databases"]
...
blacklistCompanies = ["Jobot", "Cybercoders", "Braintrust"]
#Blaclist keywords in title - ex:["manager", ".Net"]
blackListTitles = ["Architect", "Manager", "Staff", "hybrid", "frontend"]
