...
def getUrlDataFile():
    ...
    try:
        ...
        text = "FileNotFound:urlData.txt file is not found. Please run ./data folder exists and check commonconfig.py values of yours. Then run the bot again"
        prRed(text)
    return urlData
    ...
    def generateUrlLinks(self):
        ...
        for location in config.location:
            for keyword in config.keywords:
                url = constants.linkJobUrl + "?f_AL=true&keywords=" + keyword + self.jobType() + self.remote() + self.checkJobLocation(
